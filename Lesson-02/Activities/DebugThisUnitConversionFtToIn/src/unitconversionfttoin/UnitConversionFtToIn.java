...
public class UnitConversionFtToIn {
    ...
    { // Open { was missing
        ...
        int ft, in; // int ft; in; <--- variables should be seperated by comma example: String firstMame, lastName;
        ft = inputInches / 12; // feet = inches divided by 12
        in = inputInches % 12; // inches = inches modulo (remainder) 12
        System.out.printf("%d inches == %d feet %s inches\n" // system must have capital S
                , inputInches, ft, in);
    }
}
