...
public class DebugThisJavaWTFJavaFTW {
    ...
    public static void main(String[] args) {
        System.out.println ("What the F-*bleep*, Java?"); //System.out.println "What the F-*bleep*, Java?";
        System.out.print("Oops,"); //System.out.print("Oops,")
        System.out.printf("my bad.");
        System.out.println("Java, for the win!"); //System.println("Java, for the win!");
    }
}
